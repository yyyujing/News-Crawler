...
def main():
    ...
    dataFile1 = 'C:/Users/Chinaintern_2/Documents/newscheyun.csv' #爬取的网站新闻数据
    data1 = pd.read_csv(dataFile1) #从csv数据表中读数据
    dataFile2 = 'C:/Users/Chinaintern_2/Documents/newsgongye.csv'
    data2 = pd.read_csv(dataFile2)
    dataFile3 = 'C:/Users/Chinaintern_2/Documents/newsshiyou.csv'
    data3 = pd.read_csv(dataFile3)
    dataFile4 = 'C:/Users/Chinaintern_2/Documents/newsdiyidiandong.csv'
    data4 = pd.read_csv(dataFile4)
    dataFile5 = 'C:/Users/Chinaintern_2/Documents/newsleifengwang.csv'
    data5 = pd.read_csv(dataFile5)
    dataFile6 = 'C:/Users/Chinaintern_2/Documents/newsxinnengyuanqiche.csv'
    data6 = pd.read_csv(dataFile6)
    dataFile7 = 'C:/Users/Chinaintern_2/Documents/newsqichegongye.csv'
    data7 = pd.read_csv(dataFile7)
    dataFile8 = 'C:/Users/Chinaintern_2/Documents/newsxny.csv'
    data8 = pd.read_csv(dataFile8)
    ...
    result4 = getKeywords_tfidf(data4, stopkey, 4)
    result5 = getKeywords_tfidf(data5, stopkey, 4)
    result6 = getKeywords_tfidf(data6, stopkey, 4)
    result7 = getKeywords_tfidf(data7, stopkey, 4)
    result8 = getKeywords_tfidf(data8, stopkey, 4)
    resultfinal= result.append([result2,result3,result4,result5,result6,result7,result8]) #要拼接大于一个的，括号里用[result1,result2,...]
    print(resultfinal)
    resultfinal.to_csv("result/keys_TFIDF2.csv",encoding= 'utf-8', index=False)
